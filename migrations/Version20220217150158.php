 ...
 */
final class Version20220217150158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE promotion_domaine (promotion_id INT NOT NULL, domaine_id INT NOT NULL, INDEX IDX_20D2FCF6139DF194 (promotion_id), INDEX IDX_20D2FCF64272FC9F (domaine_id), PRIMARY KEY(promotion_id, domaine_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE promotion_domaine ADD CONSTRAINT FK_20D2FCF6139DF194 FOREIGN KEY (promotion_id) REFERENCES promotion (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE promotion_domaine ADD CONSTRAINT FK_20D2FCF64272FC9F FOREIGN KEY (domaine_id) REFERENCES domaine (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE promotion_domaine');
