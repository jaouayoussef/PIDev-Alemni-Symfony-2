 ...
 */
final class Version20220307193927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, e_name VARCHAR(255) NOT NULL, e_photo VARCHAR(255) NOT NULL, e_note VARCHAR(255) DEFAULT NULL, e_place VARCHAR(255) NOT NULL, e_price DOUBLE PRECISION NOT NULL, e_tel_number INT NOT NULL, e_email VARCHAR(255) NOT NULL, e_date_debut DATETIME NOT NULL, e_date_fin DATETIME NOT NULL, e_nbre INT NOT NULL, e_place_reserver INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, user_file VARCHAR(255) DEFAULT NULL, sending_date DATETIME NOT NULL, INDEX IDX_CE606404A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE userresult (id INT AUTO_INCREMENT NOT NULL, quiz_id INT DEFAULT NULL, id_user_id INT NOT NULL, result INT NOT NULL, INDEX IDX_7B90D6D7853CD175 (quiz_id), INDEX IDX_7B90D6D779F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE userresult ADD CONSTRAINT FK_7B90D6D7853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (id)');
        $this->addSql('ALTER TABLE userresult ADD CONSTRAINT FK_7B90D6D779F37AE5 FOREIGN KEY (id_user_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE userresult DROP FOREIGN KEY FK_7B90D6D7853CD175');
        ...
        $this->addSql('ALTER TABLE userresult DROP FOREIGN KEY FK_7B90D6D779F37AE5');
