 ...
 */
final class Version20220226180516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, domaine_id INT NOT NULL, nom_formation VARCHAR(255) NOT NULL, description_formation VARCHAR(255) NOT NULL, lien VARCHAR(255) NOT NULL, prix_formation DOUBLE PRECISION NOT NULL, image_formation VARCHAR(255) NOT NULL, formateur VARCHAR(255) NOT NULL, nb_places INT NOT NULL, INDEX IDX_404021BF4272FC9F (domaine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE promo_code_owner (id INT AUTO_INCREMENT NOT NULL, pcd_name VARCHAR(255) NOT NULL, pcd_first_name VARCHAR(255) NOT NULL, pcd_email VARCHAR(255) NOT NULL, pcd_job VARCHAR(255) NOT NULL, pcd_telephone_number NUMERIC(10, 0) NOT NULL, pcd_gender VARCHAR(255) NOT NULL, pcd_city VARCHAR(255) NOT NULL, pcd_note VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_7FAE5F53EB5F299E (pcd_email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, p_domaine_id INT NOT NULL, p_name VARCHAR(255) NOT NULL, p_value INT NOT NULL, p_date_b DATE NOT NULL, p_date_f DATE NOT NULL, p_note VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C11D7DD11521FA90 (p_domaine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE promotion_code (id INT AUTO_INCREMENT NOT NULL, cp_pcd_id INT NOT NULL, pc_code VARCHAR(255) NOT NULL, pc_value INT NOT NULL, pc_expiration_code DATE NOT NULL, pc_note VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C1EFB8071376C53F (pc_code), INDEX IDX_C1EFB8072DEDD2B (cp_pcd_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
