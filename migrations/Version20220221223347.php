 ...
 */
final class Version20220221223347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE useranswer CHANGE rep_correct rep_correct INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE useranswer CHANGE rep_correct rep_correct INT NOT NULL');
    }
}
